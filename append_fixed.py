...
with open(r'c:\home\git\simtiva\PropofolModels.mo', 'r') as f:
    content = f.read()

models_to_copy = ['PropofolMarsh', 'PropofolSchnider', 'PropofolPaedfusor', 'PropofolEleveld']
new_content = content
...
with open(r'c:\home\git\simtiva\PropofolModels.mo', 'w') as f:
    f.write(new_content)
print("Done appending newly parsed isolated variants.")
